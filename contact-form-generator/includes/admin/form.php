...
$wpcfg_email_to = $id == 0 ? '' : esc_attr($row->email_to);
$wpcfg_email_bcc = $id == 0 ? '' : esc_attr($row->email_bcc);
$wpcfg_email_subject = $id == 0 ? '' : esc_attr($row->email_subject);
$wpcfg_email_from = $id == 0 ? '' : esc_attr($row->email_from);
$wpcfg_email_from_name = $id == 0 ? '' : esc_attr($row->email_from_name);
$wpcfg_email_replyto = $id == 0 ? '' : esc_attr($row->email_replyto);
$wpcfg_email_replyto_name = $id == 0 ? '' : esc_attr($row->email_replyto_name);
...
<table class="wpcfg_table">
	...
	<tr>
		...
		<td>
			<textarea id="wpcfg_custom_css" name="custom_css" style="height: 300px;"><?php echo esc_html($wpcfg_custom_css);?></textarea>
		</td>	
	</tr>
</table>
