...
check_ajax_referer('wpgs_ajax_nonce_value');
...
if($get_token == 0) {
	...
	// $session_token = isset($_SESSION['contactformgenerator_token']) ? $_SESSION['contactformgenerator_token'] : '';
